...
@section('style')
    <link href="{{ asset('_lpv90/css/c-wizard.css') }}" rel="stylesheet">
@endsection

@section('content')
    @include('lpv90.partials.top_header')
    <div class="main-wrapper">
        @include('lpv90.partials.header_home')
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="hero-inner text-center">
                                    ...
                                    <form method="post" action="{{ route('energybill.zip.post', ['route_name' => 'lpv90']) }}">
                                        {{ csrf_field() }}
            ...
            <div class="row align-items-center">
                <div class="col-md-6 col-sm-12 col-12">
                    <div class="government-left position-relative">
                        ...
                        <img src="{{ asset('_lpv90/images/electrician-installing.jpg') }}" alt="">
                        </div>
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="report-list text-center">
                        <div class="icon"><img src="{{ asset('_lpv90/images/save-icon.svg') }}" alt=""></div>
                        <div class="content">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="report-list text-center">
                        <div class="icon"><img src="{{ asset('_lpv90/images/reduce-co2-emissions.svg') }}" alt=""></div>
                        <div class="content">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="report-list text-center">
                        <div class="icon"><img src="{{ asset('_lpv90/images/planting-icon.svg') }}" alt=""></div>
                        <div class="content">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="report-list text-center">
                        <div class="icon"><img src="{{ asset('_lpv90/images/equivalent-driving-icon.svg') }}" alt=""></div>
                        <div class="content">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="going-solar-media">
                        <img src="{{ asset('_lpv90/images/solar-plant.png') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">

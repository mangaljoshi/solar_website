...
@section('content')
    <div id="loading" style="display: none;">
        <img id="loading-image" src="{{ asset('_lpv90/images/loader.gif') }}" alt="Loading..." />
    </div>
                ...
                <header class="header-main position-static pb-0 text-center">
                    <div class="container">
                        ...
                        <div class="col-sm-12">
                            <div class="lock"></div>
                            <div class="hero-logo">
                                <a href="{{ route('home') }}"><img src="{{ asset('_lpv90/images/logo.png') }}" alt=""></a>
                            </div>
                                                            ...
                                                            <div class="row justify-content-center">
                                                                    ...
                                                                    <div class="sunlight-box text-center">
                                                                        <a href="javascript:void(0);" class="step3 homeType">
                                                                            <div class="sunlight-ico">
                                                                                <img class="home-img" src="{{asset('_lpv90/images/single-family-outline.svg')}}" alt="">
                                                                            </div>
                                                                ...
                                                                <div class="col-6 col-666 col-sm-6">
                                                                    <div class="sunlight-box text-center">
                                                                        <a href="javascript:void(0);" class="step3 homeType">
                                                                            <div class="sunlight-ico">
                                                                            <img class="home-img" src="{{asset('_lpv90/images/multi-family-outline.svg')}}" alt="">
                                                                            </div>
                                                                ...
                                                                <div class="col-6 col-666 col-sm-6">
                                                                    <div class="sunlight-box text-center">
                                                                        <a href="javascript:void(0);" class="step3 homeType">
                                                                            <div class="sunlight-ico">
                                                                            <img class="home-img" src="{{asset('_lpv90/images/mobile-home-outline.svg')}}" alt="">
                                                                            </div>
                                                                ...
                                                                <div class="col-6 col-666 col-sm-6">
                                                                    <div class="sunlight-box text-center">
                                                                        <a href="javascript:void(0);" class="step3 homeType">
                                                                            <div class="sunlight-ico">
                                                                            <img class="home-img" src="{{asset('_lpv90/images/townhome-outline.svg')}}" alt="">
                                                                            </div>
                                                        ...
                                                        <div class="wizard__main mx-680">
                                                            ...
                                                            <div class="col-sm-6 col-6">
                                                                <div class="sunlight-box text-center">
                                                                    <a href="javascript:void(0);" class="step5 roofSunlight">
                                                                        <div class="sunlight-ico">
                                                                        <img src="{{ asset('_lpv90/images/no-shade.svg') }}" alt="">
                                                                        </div>
                                                            ...
                                                            <div class="col-sm-6 col-6">
                                                                <div class="sunlight-box text-center">
                                                                    <a href="javascript:void(0);" class="step5 roofSunlight">
                                                                        <div class="sunlight-ico">
                                                                        <img src="{{ asset('_lpv90/images/little-shade.svg') }}" alt="">
                                                                        </div>
                                                            ...
                                                            <div class="col-sm-6 col-6">
                                                                <div class="sunlight-box text-center">
                                                                    <a href="javascript:void(0);" class="step5 roofSunlight">
                                                                        <div class="sunlight-ico">
                                                                        <img src="{{ asset('_lpv90/images/lot-of-shade.svg') }}" alt="">
                                                                        </div>
                                                            ...
                                                            <div class="col-sm-6 col-6">
                                                                <div class="sunlight-box text-center">
                                                                    <a href="javascript:void(0);" class="step5 roofSunlight">
                                                                        <div class="sunlight-ico">
                                                                        <img src="{{ asset('_lpv90/images/uncertain.svg') }}" alt="">
                                                                        </div>

...
@section('style')
    <link href="{{ asset('_lpv90/css/second-service.css') }}" rel="stylesheet">
@endsection

@section('script')
    <script src="{{ asset('_lpv90/js/second-service.js') }}" type="text/javascript" ></script>
@endsection
                            ...
                            <div class="wizard__box">
                                ...
                                <div class="row test-center thank-text-center">
                                    ...
                                    <div class="col-md-12 thank-you-banner-2" style="text-align:center">
                                        ...
                                        <img src="{{asset('_lpv90/images/banner1.jpg')}}" style="border-radius: 20px" alt="thank-you-banner">
                                                        ...
                                                        <div class="mt-xs-30">
                                                            ...
                                                            <div class="row justify-content-cente">
                                                                ...
                                                                <div style="display: grid; place-items:center"> 
                                                                    <a href="{{route('energybill.thank.you.service', ['route_name' => 'lpv90'])}}"
                                                                     {{-- <p --}}
                                        ...
                                        <div class="yell-wrapper box-2">
                                            ...
                                            <div class="yell">
                                                ...
                                                <div class="credit-score d-none d-sm-block d-md-block">
                                                    <a href=""><img src="{{ asset('_lpv90/images/thank-you-image.png') }}"></a>
                                                </div>
                ...
                <section class="s-pb testimonial-section page-paddings pt-0">
                    <div class="container">
                        ...
                        <div class="item">
                            <div class="ts-block">
                                <div class="ts-author">
                                    <img src="{{ asset('_lpv90/images/testimonial-1.png') }}" width="60" height="60" alt="">
                                    <div class="content">
                                    <h3 class="theme-title">Linda R.</h3>
                                    <div class="rating">
                                        <span><img src="{{ asset('_lpv90/images/star-fill-icon.svg') }}" width="17" height="16" alt=""></span>
                                        <span><img src="{{ asset('_lpv90/images/star-fill-icon.svg') }}" width="17" height="16" alt=""></span>
                                        <span><img src="{{ asset('_lpv90/images/star-fill-icon.svg') }}" width="17" height="16" alt=""></span>
                                        <span><img src="{{ asset('_lpv90/images/star-fill-icon.svg') }}" width="17" height="16" alt=""></span>
                                        <span><img src="{{ asset('_lpv90/images/star-fill-icon.svg') }}" width="17" height="16" alt=""></span>
                        ...
                        <div class="item">
                            <div class="ts-block">
                                <div class="ts-author">
                                    <img src="{{ asset('_lpv90/images/testimonial-2.png') }}" width="60" height="60" alt="">
                                    <div class="content">
                        ...
                        <div class="item">
                            <div class="ts-block">
                                <div class="ts-author">
                                    <img src="{{ asset('_lpv90/images/testimonial-3.png') }}" width="60" height="60" alt="">
                                    <div class="content">

                                                            ...
                                                            <div class="wizard__box">
                                                                ...
                                                                <div class="wizard__main mx-680">
                                                                    <div class="row justify-content-center">
                                                                        ...
                                                                        <input type="hidden" id="leadid_tcpa_disclosure" name="tcpa" tabindex="0" value='By clicking the "View My Savings" button, you authorize www.wiseenergypower.com and up to 4 solar partners to call you and send you pre-recorded messages and text messages at the number you entered above, using an autodialer, with offers about their products or services, even if your phone number is on any national or state "Do Not Call" list. Message and data rates may apply. Your consent here is not based on a condition of purchase. You agree to the Terms of Use and Privacy Policy.'>
                                                                        </div>

...
@section('style')
    ...
    <link href="{{ asset('_lpv88/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('_lpv88/css/style.css') }}" rel="stylesheet">
    <link href="{{ asset('_lpv88/css/responsive.css') }}" rel="stylesheet">
    <link href="{{ asset('_lpv88/css/owl.carousel.min.css') }}" rel="stylesheet">
    <link href="{{ asset('_lpv88/fontawesome/css/all.min.css') }}" rel="stylesheet">
@endsection
                            ...
                            <div class="wizard__box">
                                ...
                                <div class="row test-center thank-text-center">
                                    ...
                                    <div class="col-md-12 thank-you-banner-2" style="text-align:center">
                                        ...
                                        <img src="{{asset('_lpv23/images/banner1.jpg')}}" style="border-radius: 20px" alt="thank-you-banner">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-wrapper second-service-wrapper pt-xs-20 pb-xs-20 pl-xs-15 pr-xs-15 pl-sm-30 pr-sm-30 pl-lg-40 pr-lg-40">                                            
                                                ...
                                                <div class="second-service mt-xs-30">
                                                    ...
                                                    <form novalidate="novalidate" action="{{ route('energybill.second.service', ['route_name' => 'lpv23']) }}" accept-charset="UTF-8" method="post">
                                                        @csrf()
                                                        <div class="service">
                                                            ...
                                                            <div class="row justify-content-cente">
                                                                ...
                                                                <div style="display: grid; place-items:center"> 
                                                                    <a href="{{route('energybill.thank.you.service', ['route_name' => 'lpv23'])}}"
                                                                     {{-- <p --}}
                                                                    className="mt-30" style="font-size: 18px; margin-top:20px; cursor: pointer;">
                                                                    No Thanks
                                                                    {{-- </p> --}}
                                                                </a> 
                                                                </div>
                                        ...
                                        <div class="yell-wrapper box-2">
                                            ...
                                            <div class="yell">
                                                ...
                                                <div class="credit-score d-none d-sm-block d-md-block">
                                                    <a href=""><img src="{{ asset('_lpv23/images/thank-you-image.png') }}"></a>
                                                </div>
                ...
                {{-- <section class="s-pb testimonial-section page-paddings pt-0">
                    <div class="container">
                        ...
                        <div class="item">
                            <div class="ts-block">
                                <div class="ts-author">
                                    <img src="{{ asset('_lpv23/images/testimonial-1.png') }}" width="60" height="60" alt="">
                                    <div class="content">
                                    <h3 class="theme-title">Linda R.</h3>
                                    <div class="rating">
                                        <span><img src="{{ asset('_lpv23/images/star-fill-icon.svg') }}" width="17" height="16" alt=""></span>
                                        <span><img src="{{ asset('_lpv23/images/star-fill-icon.svg') }}" width="17" height="16" alt=""></span>
                                        <span><img src="{{ asset('_lpv23/images/star-fill-icon.svg') }}" width="17" height="16" alt=""></span>
                                        <span><img src="{{ asset('_lpv23/images/star-fill-icon.svg') }}" width="17" height="16" alt=""></span>
                                        <span><img src="{{ asset('_lpv23/images/star-fill-icon.svg') }}" width="17" height="16" alt=""></span>
                        ...
                        <div class="item">
                            <div class="ts-block">
                                <div class="ts-author">
                                    <img src="{{ asset('_lpv23/images/testimonial-2.png') }}" width="60" height="60" alt="">
                                    <div class="content">
                        ...
                        <div class="item">
                            <div class="ts-block">
                                <div class="ts-author">
                                    <img src="{{ asset('_lpv23/images/testimonial-3.png') }}" width="60" height="60" alt="">
                                    <div class="content">

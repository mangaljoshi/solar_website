                        ...
                        <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                            <div class="wizard__box">
                                <div class="page-title text-center mb-2">
                                    <h2>You’ve been Pre-Qualified for $0 Out of Pocket Solar with Estimated Savings of <span style="color:#FB7306"> $45,243*</span></h2>
                                    <p class="">*based on a special offer from a solar provider.Expect a phone call from a solar expert to claim the offer and your spot in the line.</p>
                                ...
                                <div class="wizard__main">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="card-deck mb-3 text-center">
                                            ...
                                            <div class="card-header " style="width:81%;background-color:#2dc254;border-radius:4px;height:42px">
                                                <h4 class="my-0 font-weight-normal" style="color:white;font-weight:700;text-align:left"><i class="fas fa-check fa-sm" style="color: #2dc254; background-color:white;border-radius:50%;width:30px;height:30px!important;padding:5px;margin-right:7px;"></i>Recommended For You</h4>
                                            </div>
                                            <div class="card-body">
                                            <div class="text-center">
                                                    <div class="cta-title text-center mb-2 text-dark">

                                                        ...
                                                        <div class="mt-xs-30">
                                                            ...
                                                            <div class="row justify-content-cente">
                                                                ...
                                                                <div style="display: grid; place-items:center"> 
                                                                    <a href="{{route('energybill.thank.you.service', ['route_name' => 'lpv88'])}}"
                                                                     {{-- <p --}}
                                        ...
                                        <div class="yell-wrapper box-2">
                                            ...
                                            <div class="yell">
                                                ...
                                                <div class="credit-score d-none d-sm-block d-md-block">
                                                    <a href=""><img src="{{ asset('_lpv88/images/thank-you-image.png') }}"></a>
                                                </div>
                ...
                <section class="s-pb testimonial-section page-paddings pt-0">
                    <div class="container">
                        ...
                        <div class="item">
                            <div class="ts-block">
                                <div class="ts-author">
                                    <img src="{{ asset('_lpv88/images/testimonial-1.png') }}" width="60" height="60" alt="">
                                    <div class="content">
                                    <h3 class="theme-title">Linda R.</h3>
                                    <div class="rating">
                                        <span><img src="{{ asset('_lpv88/images/star-fill-icon.svg') }}" width="17" height="16" alt=""></span>
                                        <span><img src="{{ asset('_lpv88/images/star-fill-icon.svg') }}" width="17" height="16" alt=""></span>
                                        <span><img src="{{ asset('_lpv88/images/star-fill-icon.svg') }}" width="17" height="16" alt=""></span>
                                        <span><img src="{{ asset('_lpv88/images/star-fill-icon.svg') }}" width="17" height="16" alt=""></span>
                                        <span><img src="{{ asset('_lpv88/images/star-fill-icon.svg') }}" width="17" height="16" alt=""></span>
                        ...
                        <div class="item">
                            <div class="ts-block">
                                <div class="ts-author">
                                    <img src="{{ asset('_lpv88/images/testimonial-2.png') }}" width="60" height="60" alt="">
                                    <div class="content">
                        ...
                        <div class="item">
                            <div class="ts-block">
                                <div class="ts-author">
                                    <img src="{{ asset('_lpv88/images/testimonial-3.png') }}" width="60" height="60" alt="">
                                    <div class="content">

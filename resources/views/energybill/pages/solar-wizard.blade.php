...
{{-- @include('energybill.partials.header_common') --}}
    <div id="loading" style="display: none;">
        <img id="loading-image" src="{{ asset('_energybill/images/loader.gif') }}" alt="Loading..." />
    </div>
            ...
            <div class="d-table-cell">
                <header class="header-main position-static pb-0 text-center">
                    <div class="container">
                        ...
                        <div class="col-sm-12">
                            <div class="hero-logo">
                                <a href="{{ route('home', ['route_name' => 'energybill']) }}"><img src="{{ asset('_energybill/images/logo.png') }}" alt=""></a>
                            </div>
                                            ...
                                            <div class="wizard__main mx-680">
                                                <div class="row justify-content-center">
                                                    <div class="col-xs-12 col-sm-3 col-md-3">
                                                        <a href="javascript:void(0);" class="step4 roofSunlight sunlight-box text-center">
                                                            <div class="sunlight-ico">
                                                                <img src="{{ asset('_energybill/images/noshade.svg') }}" alt="">
                                                            </div>
                                                    ...
                                                    <div class="col-xs-12 col-sm-3 col-md-3">
                                                        <a href="javascript:void(0);" class="step4 roofSunlight sunlight-box text-center">
                                                            <div class="sunlight-ico">
                                                                <img src="{{ asset('_energybill/images/littleshade.svg') }}" alt="">
                                                            </div>
                                                    ...
                                                    <div class="col-xs-12 col-sm-3 col-md-3">
                                                        <a href="javascript:void(0);" class="step4 roofSunlight sunlight-box text-center">
                                                            <div class="sunlight-ico">
                                                                <img src="{{ asset('_energybill/images/alotshade.svg') }}" alt="">
                                                            </div>
                                                    ...
                                                    <div class="col-xs-12 col-sm-3 col-md-3">
                                                        <a href="javascript:void(0);" class="step4 roofSunlight sunlight-box text-center">
                                                            <div class="sunlight-ico">
                                                                <img src="{{ asset('_energybill/images/uncertain.svg') }}" alt="">
                                                            </div>

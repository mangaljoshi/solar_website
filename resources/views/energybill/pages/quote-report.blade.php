        ...
        <div class="d-table w-100">
            <div class="d-table-cell">
                <div class="d-none d-sm-block d-md-block">
                    {{-- @include('_energybill.partials.header_home') --}}
                </div>
                                            ...
                                            <div class="yell solar-saver">
                                                ...
                                                <div class="row justify-content-around">
                                                    <div class="col-xs-12 col-sm-12 col-md-8  text-center text-dark">
                                                        <img src="{{ asset('_energybill/images/solar-saver-program-logo.png') }}" alt="Solar Saver Program-logo" class="object-contain">
                                                    </div>
                                                </div>
                                                <div class="row justify-content-around">
                                        ...
                                        <div class="yell-wrapper">
                                            ...
                                            <div class="yell">
                                                ...
                                                <div class="credit-score d-none d-sm-block d-md-block">
                                                    <a href=""><img src="{{ asset('_energybill/images/thank-you-image.png') }}"></a>
                                                </div>
                ...
                <section class="s-pb testimonial-section page-paddings pt-0">
                    <div class="container">
                        ...
                        <div class="item">
                            <div class="ts-block">
                                <div class="ts-author">
                                    <img src="{{ asset('_energybill/images/testimonial-1.png') }}" width="60" height="60" alt="">
                                    <div class="content">
                                    <h3 class="theme-title">Linda R.</h3>
                                    <div class="rating">
                                        <span><img src="{{ asset('_energybill/images/star-fill-icon.svg') }}" width="17" height="16" alt=""></span>
                                        <span><img src="{{ asset('_energybill/images/star-fill-icon.svg') }}" width="17" height="16" alt=""></span>
                                        <span><img src="{{ asset('_energybill/images/star-fill-icon.svg') }}" width="17" height="16" alt=""></span>
                                        <span><img src="{{ asset('_energybill/images/star-fill-icon.svg') }}" width="17" height="16" alt=""></span>
                                        <span><img src="{{ asset('_energybill/images/star-fill-icon.svg') }}" width="17" height="16" alt=""></span>
                        ...
                        <div class="item">
                            <div class="ts-block">
                                <div class="ts-author">
                                    <img src="{{ asset('_energybill/images/testimonial-2.png') }}" width="60" height="60" alt="">
                                    <div class="content">
                        ...
                        <div class="item">
                            <div class="ts-block">
                                <div class="ts-author">
                                    <img src="{{ asset('_energybill/images/testimonial-3.png') }}" width="60" height="60" alt="">
                                    <div class="content">
